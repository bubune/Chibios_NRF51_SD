...
#define NRF_POWER_RAMONx_RAMxON_ONMODE_Msk 0x3
 ...
 /* Make sure ALL RAM banks are powered on */
//  asm volatile ("movs R1, =#NRF_POWER_RAMONx_RAMxON_ONMODE_Msk");
//
//  asm volatile ("ldr  r0, =NRF_POWER_RAMON_ADDRESS");
//  asm volatile ("ldr  r2, [r0]");
//  asm volatile ("orrs r2, r1");
//  asm volatile ("str  R2, [r0]");
//
//  asm volatile ("ldr  r0, =NRF_POWER_RAMONB_ADDRESS");
//  asm volatile ("ldr  r2, [r0]");
//  asm volatile ("orrs r2, r1");
//  asm volatile ("str  R2, [r0]");
#endif
  ...
  asm volatile ("cpsid   i");  // -> fait planter softdevice
  ...
  reg = CRT0_CONTROL_INIT;  // cette valeur fait planter le softdevice
#endif
